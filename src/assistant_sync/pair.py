...
WORD_LIST: tuple[str, ...] = (
    ...
    "ZENITH", "BIRCH", "COMET", "DEPOT", "FINCH", "GRAIL", "HAVEN", "IRIS",
    "KNOLL", "LUNAR", "MANOR", "NEXUS", "OPAL", "PETAL", "QUILT", "ROBIN",
    "SABLE", "TALON", "ULTRA", "VIGOR", "WEDGE", "XERUS", "YUCCA", "ZEPHYR",
    "ASPEN", "BASIL", "CINDER", "DRAKE", "EMBER", "FJORD", "GLACIER", "HARBOR",
    "ICICLE", "JASPER", "KESTREL", "LANTERN", "MAGNET", "NECTAR", "OSPREY", "PEBBLE",
    "QUARRY", "RAPIDS", "SUMMIT", "TRELLIS", "UMBER", "VALLEY", "WANDER", "YARROW",
    "ZENITH", "ALPINE", "BREEZE", "COPPER", "DAPPLE", "ECLIPSE", "FATHOM", "GARNET",
)
