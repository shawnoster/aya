...
WORD_LIST: tuple[str, ...] = (
    ...
    "BLADE", "BLAZE", "BLOOM", "BOARD", "BOLT", "BOWER", "BRAKE", "BRAVE",
    "BRICK", "BROOK", "BRUSH", "CAIRN", "CALM", "CANOE", "CARGO", "CEDAR",
    "CHAIN", "CHALK", "CHASE", "CHIEF", "CLIFF", "CLIMB", "CLOUD", "CLOVER",
    "COBRA", "CORAL", "CRANE", "CREEK", "CREST", "CROWN", "CRUSH", "DAGGER",
    "DELTA", "DIVER", "DOCK", "DRAFT", "DRIFT", "DRUM", "DUNE", "EAGLE",
    "EARTH", "EMBER", "FABLE", "FALCON", "FERN", "FIELD", "FLAME", "FLARE",
    "FLASH", "FLINT", "FLOOD", "FORGE", "FROST", "GALE", "GATE", "GAVEL",
    "GHOST", "GLADE", "GLEAM", "GLOBE", "GRAIN", "GRANT", "GRAPE", "GROVE",
    "GUARD", "GUILD", "HAVEN", "HAWK", "HAZEL", "HEART", "HEDGE", "HERON",
    "HIKER", "HONOR", "HOVER", "INLET", "IVORY", "JADE", "JETTY", "JEWEL",
    "KARMA", "KAYAK", "LANCE", "LARCH", "LASER", "LATCH", "LEDGE", "LEVER",
    "LIGHT", "LILAC", "LINEN", "LODGE", "LUNAR", "MAPLE", "MARCH", "MARSH",
    "MASON", "MEDAL", "MERGE", "MESA", "METAL", "MIRTH", "MIST", "MOOSE",
    "MOUNT", "NOBLE", "NORTH", "OASIS", "OLIVE", "ONYX", "ORBIT", "OTTER",
    "OXIDE", "PANEL", "PATCH", "PEARL", "PERCH", "PILOT", "PINE", "PIXEL",
    "PLAIN", "PLANT", "PLAZA", "PLUMB", "PLUME", "POLAR", "POND", "PORTER",
    "PRISM", "PULSE", "QUAIL", "QUARTZ", "QUEST", "RAPID", "RAVEN", "REALM",
    "REEF", "RIDGE", "RIVET", "ROOST", "ROVER", "ROYAL", "SAGE", "SCALE",
    "SCOUT", "SHARD", "SHELL", "SHORE", "SIGMA", "SLATE", "SLOPE", "SOLAR",
    "SPARK", "SPIRE", "SPOKE", "SPRAY", "SQUID", "STAG", "STEAM", "STEEL",
    "STONE", "STORM", "STORK", "SURGE", "SWIFT", "THORN", "TIGER", "TIMBER",
    "TORCH", "TOWER", "TRAIL", "TROUT", "TULIP", "TUNDRA", "UNITY", "VALOR",
    "VAULT", "VENOM", "VERGE", "VIPER", "VIVID", "VOICE", "WALNUT", "WARDEN",
    "WATER", "WAVE", "WHEAT", "WILLOW", "WINGS", "WOLF", "WRAITH", "YARN",
    "ZENITH", "FLICKER", "COMET", "DEPOT", "FINCH", "GRAIL", "CONDOR", "IRIS",
    "KNOLL", "THICKET", "MANOR", "NEXUS", "OPAL", "PETAL", "QUILT", "ROBIN",
    "SABLE", "TALON", "ULTRA", "VIGOR", "WEDGE", "XERUS", "YUCCA", "ZEPHYR",
    "ASPEN", "BASIL", "CINDER", "DRAKE", "MIRAGE", "FJORD", "GLACIER", "HARBOR",
    "ICICLE", "JASPER", "KESTREL", "LANTERN", "MAGNET", "NECTAR", "OSPREY", "PEBBLE",
    "QUARRY", "RAPIDS", "SUMMIT", "TRELLIS", "UMBER", "VALLEY", "WANDER", "YARROW",
    "PARCEL", "ALPINE", "BREEZE", "COPPER", "DAPPLE", "ECLIPSE", "FATHOM", "GARNET",
)
...
async def join_pairing(
    ...
    return TrustedKey(
        did=initiator_did, label=initiator_label, nostr_pubkey=initiator_pubkey
    )
