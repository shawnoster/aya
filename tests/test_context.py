...
def test_context_cmd_no_notebook_path(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr("aya.adapters.cli.workspace_cmds.get_notebook_path", lambda: None)
...
def test_context_cmd_renders_output(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("aya.adapters.cli.workspace_cmds.get_notebook_path", lambda: nb)
